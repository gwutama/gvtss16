var app = ( function() {
	...
	var illumination ={
		ambientLight : [.5,.5,.5],
		light : [
			{isOn:true, position:[3.,0.,5], color:[1.,1.,1.]},
		]
	};
	...
	function initModels() {
		...
		createModel("sphere", fs, [1,1,1,1], [0,0,0], [-Math.PI/2.0,0,Math.PI/2.0], [2,2,2], mWhite,null);
	...
	function render() {
		...
		for(var i = 0; i < models.length; i++) {
			...
			if(!models[i].texture.loaded) { continue; }
