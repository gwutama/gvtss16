var app = ( function() {
	...
	function initModels() {
		createModel("torus", "fillwireframe", [0, 0, 0], [0, 0, 0], [1, 1, 1]);
        createModel("sphere", "fillwireframe", [1, 0, 0], [0, 0, 0], [0.5, 0.5, 0.5]);

        createModel("cube", "fillwireframe", [-1, 0, 0], [0, 0, 0], [0.5, 0.5, 0.5]);
        createModel("cube", "fillwireframe", [-1, 0, 0.2], [0, 0, 0], [0.4, 0.4, 0.4]);
        createModel("cube", "fillwireframe", [-1, 0, 0.4], [0, 0, 0], [0.3, 0.3, 0.3]);

        createModel("pyramid", "fillwireframe", [1, 0.6, 0], [0, 0, 0], [0.4, 0.4, 0.4]);

        createModel("plane", "wireframe",  [0, -1, 0], [0, 0, 0], [1, 1, 1]);
	}
